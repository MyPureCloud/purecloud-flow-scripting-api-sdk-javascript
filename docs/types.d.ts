...
declare class ArchFactoryFlows extends ArchBaseFactory {
     ...
     * a bot that is already created which you can access via. the [startUpObject]{@link ArchBaseFlowWorkflow#startUpObject} property off of the
     * flow.
    ...
    /**
     * Creates a new [common module]{@link ArchFlowCommonModule} flow.  Upon successful creation the callback function that's
    ...
    /**
     * Creates a new [in-queue call flow]{@link ArchFlowInQueueCall}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
     ...
     * an initial state that is already created which you can access via. the [startUpObject]{@link ArchBaseFlowWorkflow#startUpObject} property off of the
     * flow.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
...
declare namespace scripting {
    ...
    export namespace viewModels {
        ...
        namespace actions {
            ...
            let ArchActionAssociateExternalContact: ArchActionAssociateExternalContact;
