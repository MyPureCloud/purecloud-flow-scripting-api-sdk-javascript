...
declare class ArchDataType extends ArchBaseCoreObject {
     ...
     * actual flow instance that you would like to check, please use {@linke ArchDataType#isScriptCreatableForFlow}
...
declare class ArchSession extends ArchBaseObject {
     ...
     */
    startWithAuthToken(orgLocation: string, callbackFunctionStart: callbackSessionStart, authToken: string, callbackFunctionEnd?: callbackSessionEnd): Promise<any>;
    /**
     * This function starts an Architect Scripting session.  You will need to specify the runtime location in which
...
declare class ArchFactoryActions extends ArchBaseFactory {
    ...
    /**
     * Adds an Associate External Contact action to an {@link ArchBaseMultiActionContainer} such as an [action output]{@link ArchActionOutput}, [task]{@link ArchTask} or [state]{@link ArchState}.
     ...
     */
    addActionAssociateExternalContact(archMultiActionContainer: ArchBaseMultiActionContainer, name?: string, previousArchAction?: ArchBaseAction): ArchActionAssociateExternalContact;
    /**
    ...
    /**
     * Adds a Call Bot Connector action to an {@link ArchBaseMultiActionContainer} such as an [action output]{@link ArchActionOutput}, [task]{@link ArchTask} or [state]{@link ArchState}.
     * @param archMultiActionContainer - the Architect multi-action container where the new action should be added.  For example, an Architect Scripting state, task or action output where you want the action added.
     * @param [name] - the name for the new action.  If not specified, a name will be auto-generated by Architect Scripting based on the action type being created.
     * @param [previousArchAction] - the previous Architect action in the archBaseMultiActionContainer after which the new action should be added.  If not specified, the new action will be appended to the end of the action container.
     */
    addActionCallBotConnector(archMultiActionContainer: ArchBaseMultiActionContainer, name?: string, previousArchAction?: ArchBaseAction): ArchActionCallBotConnector;
    /**
...
/**
 * This callback function type is invoked by Architect Scripting where the callback function is passed an Architect
 * survey invite flow such as {@link ArchFactoryFlows#createFlowSurveyInvite}
...
declare class ArchFactoryFlows extends ArchBaseFactory {
    ...
    /**
     * Creates a new [bot flow]{@link ArchFlowBot}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.  The bot flow will have
     * an bot that is already created which you can access via. the [startUpObject]{@link ArchBaseWorkflow#startUpObject} property off of the
     * flow.
     ...
     *                                        Remember that divisions themselves must be [available]{@link ArchDivisions#isAvailable}
     *                                        to allow specification of a division for this parameter.
    ...
    /**
     * Creates a new [inbound call]{@link ArchFlowInboundCall} flow.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
    ...
    /**
     * Creates a new [outbound call]{@link ArchFlowOutboundCall} flow.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
    ...
    /**
     * Creates a new [in-queue]{@link ArchFlowInQueueCall} call flow.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
    ...
    /**
     * Creates a new [sub call flow]{@link ArchFlowSecureCall}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
    ...
    /**
     * Creates a new [inbound email flow]{@link ArchFlowInboundEmail}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.  The inbound email flow will have
     * an initial state that is already created which you can access via. the [startUpObject]{@link ArchBaseWorkflow#startUpObject} property off of the
     * flow.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
    ...
    /**
     * Creates a new [inbound message flow]{@link ArchFlowInboundShortMessage}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.  The inbound message flow will have
     * an initial state that is already created which you can access via. the [startUpObject]{@link ArchBaseWorkflow#startUpObject} property off of the
     * flow.  In Scripting the "Inbound Message" flow type you see in the UI is an inbound short message flow.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
     ...
     *                                        Remember that divisions themselves must be [available]{@link ArchDivisions#isAvailable}
     *                                        to allow specification of a division for this parameter.
     * @returns - while this method returns a promise, you should use the callback function to perform any processing because that callback will be passed the newly created {@link ArchInboundShortMessage} object instance.
     */
    ...
    /**
     * Creates a new [survey invite flow]{@link ArchFlowSurveyInvite}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.  The survey invite flow will have
     * an initial state that is already created which you can access via. the [startUpObject]{@link ArchBaseWorkflow#startUpObject} property off of the
     * flow.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
    ...
    /**
     * Creates a new [inbound chat flow]{@link ArchFlowInboundChat}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.  The inbound chat flow will have
     * an initial state that is already created which you can access via. the [startUpObject]{@link ArchBaseWorkflow#startUpObject} property off of the
     * flow.  In Scripting the "Inbound Chat" flow type you see in the UI is an inbound chat flow.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     * @param [defaultSupportedLanguage = {@link ArchLanguages#englishUnitedStates}] - the default language to use for the flow.
     ...
     *                                        Remember that divisions themselves must be [available]{@link ArchDivisions#isAvailable}
     *                                        to allow specification of a division for this parameter.
     * @returns - while this method returns a promise, you should use the callback function to perform any processing because that callback will be passed the newly created {@link ArchInboundChat} object instance.
     */
    ...
    /**
     * Creates a new [workflow flow]{@link ArchFlowWorkflow}.  Upon successful creation the callback function that's
     * passed in will be called with the newly created Architect flow scripting object.  The workflow will have
     * an initial state that is already created which you can access via. the [startUpObject]{@link ArchBaseWorkflow#startUpObject} property off of the
     * flow.
     * @param flowName - the name for the new flow.
     * @param [flowDescription] - the description for the new flow.
     ...
     * @returns - while this method returns a promise, you should use the callback function to perform any processing because the callback will be passed the {@link ArchBaseFlowInfoBasic} instance.
     */
     ...
     *                                                     The first parameter passed to the callback function will be the Architect Scripting
     *                                                     [flow basic information]{@link ArchFlowInfoBasic} instance.
     * @returns - while this method returns a promise, you should use the callback function to perform any processing because the callback will be passed the {@link ArchBaseFlowBasic} instance.
     */
    ...
    /**
     * Creates a new flow instance from the specified flow definition.
     ...
     *                                  You can see if a flow supports creation data by accessing the {@link ArchFlowDefinition#supportsFlowCreationData}
...
declare class ArchActionAskForSlot extends ArchBaseActionNoInputNoMatch {
     ...
     * @param undefined - the slot name to set.  This will be handled in a case-sensitive manner.
     */
    setSlot(): void;
}

/**
 * The Architect Scripting class that represents the Associate External Contact action.
 * Instances of this action should be created by calling {@link ArchFactoryActions#addActionAssociateExternalContact}
 * @param coreAssociateExternalContactWithConversationActionViewModel - ( *Internal* ) an Architect core Associate External Contact With Conversation action view model.
 */
declare class ArchActionAssociateExternalContact extends ArchBaseActionWithOutputsFoundNotFound {
    // constructor(coreAssociateExternalContactWithConversationActionViewModel: any);
    /**
     * Returns the display type name string 'ArchActionAssociateExternalContact'.
     */
    static readonly displayTypeName: string;
    /**
     * Returns true indicating that this is an ArchActionAssociateExternalContact instance.
     */
    readonly isArchActionAssociateExternalContactWithConversation: boolean;
    /**
     * The identifier of the external contact to associate with the current conversation.
     */
 ...
 */
declare class ArchActionCallBotFlow extends ArchBaseActionWithOutputs {
 ...
 * Instances of this action should be created by calling {@link ArchFactoryActions#addActionCallDialogflowBot}
 * @param coreDialogflowActionViewModel - ( *Internal* ) an Architect core Call Dialogflow Bot action view model.
 */
declare class ArchActionCallDialogflowBot extends ArchBaseActionBot {
     ...
     */
    setDialogflowAgentByIdAsync(dialogflowAgentId: string, callbackFunction?: (...params: any[]) => any): void;
    /**
     ...
     *                                        callback function will be this Architect Call Dialogflow Bot action instance.
     */
    setDialogflowAgentByNameAsync(agentName: string, projectId?: string, callbackFunction?: (...params: any[]) => any): void;
    /**
     ...
     *                                        callback function will be this Architect Call Dialogflow Bot action instance.
     */
    setDialogflowAgentByIdWithEnvironmentAsync(dialogflowAgentId: string, environmentName: string, callbackFunction?: (...params: any[]) => any): void;
    /**
     ...
     *                                        callback function will be this Architect Call Dialogflow Bot action instance.
     */
    setDialogflowAgentByNameWithEnvironmentAsync(agentName: string, environmentName: string, projectId?: string, callbackFunction?: (...params: any[]) => any): void;
}
 ...
 * table lookup action instance such as {@link ArchActionDataTableLookup#setBaseIntegrationActionByIdAsync}
 ...
 * set settings on the action as it will enable / disable the properties that can be set appropriately.  See the [transfer target type]{@link ArchActionTransferToVoicemail#targetTransferType}
...
declare class ArchBaseAction extends ArchBaseCoreObjectWithId {
     ...
     * var archDecisionActionDefinition = scripting.viewModels.actions.ArchActionDecision.definition;
     * // or for a given ArchActionDecision action instance:
     * var archDecisionActionDefinition = archDecisionActionInstance.definition;
     *
     * ```
     */
...
/**
 * This callback function type is invoked by Architect Scripting where the callback function is passed an Architect call
 * data action instance such as {@link ArchBaseActionDataAction#setBaseIntegrationActionByIdAsync}
...
declare class ArchBaseMenu extends ArchBaseCoreObjectWithId {
     ...
     * ```
     * // Example code - remember, only access this when your Scripting session is connected!
     * var archDisconnectMenuDefinition = scripting.viewModels.menus.ArchMenuDisconnect.definition;
     * // or for a given ArchMenuDisconnect menu instance:
     * var archDisconnectMenuDefinition = archDisconnectMenuInstance.definition;
     * ```
     */
...
declare class ArchBaseValue extends ArchBaseCoreObject {
     ...
     * ```
     * // Example code - remember, only access this when your Scripting session is connected!
     * var archValueStringDefinition = scripting.viewModels.values.ArchValueString.definition;
     * ```
     */
...
declare class ArchBaseVariable extends ArchBaseCoreObjectWithId {
     ...
     * ```
     * // Example code - remember, only access this when your Scripting session is connected!
     * var archVariableStringDefinition = scripting.viewModels.variables.ArchVariableString.definition;
     * ```
     */
...
declare class ArchBaseVariableValuePair extends ArchBaseCoreObject {
     ...
     * @param undefined - the variable being assigned to.
     */
    setVariableToAssignTo(): void;
    /**
 ...
 * {@link ArchFlowInfoVersions#versionPublished} property.
...
declare class ArchTask extends ArchBaseMultiActionContainer {
     ...
     * @param undefined - if a string, this should be the output ID.
...
/**
 * + This class represents a collectionvariable in Architect Scripting.
 * + Data Type:  AgentScorePair
 * Note: Do not attempt to create an instance of this class directly.
 * Instances of this class will be created automatically by Architect
 * Scripting as needed.
 ...
 * @param coreVariableViewModel - ( *Internal* ) an Architect core variable view model.
 */
declare class ArchVariableRecording extends ArchBaseVariableSingleton {
    // constructor(coreVariableViewModel: any);
}
...
declare namespace scripting {
    ...
    export namespace dataTypes {
        var ArchDataType: ArchDataType;
        var ArchDataTypes: ArchDataTypes;
    }
    /**
    ...
    export namespace environment {
        var archSession: ArchSession;
        var ArchOrganizationInfo: ArchOrganizationInfo;
        var ArchScriptingInfo: ArchScriptingInfo;
        /**
         * This namespace contains Architect Scripting organization related view models.
         */
        namespace organization {
            var ArchDivision: ArchDivision;
        }
    }
    /**
    ...
    export namespace factories {
        var archFactoryActions: ArchFactoryActions;
        var archFactoryFilters: ArchFactoryFilters;
        var archFactoryFlows: ArchFactoryFlows;
        var archFactoryMenus: ArchFactoryMenus;
        var archFactoryPromise: ArchFactoryPromise;
        var archFactoryPrompts: ArchFactoryPrompts;
        var archFactoryStates: ArchFactoryStates;
        var archFactoryTasks: ArchFactoryTasks;
    }
    /**
     * The namespace for Architect Scripting language support.
     */
    export namespace languages {
        var ArchLanguage: ArchLanguage;
        var archLanguages: ArchLanguages;
    }
    /**
    ...
    export namespace services {
        var archAsyncTracker: ArchAsyncTracker;
        var archLogging: ArchLogging;
    }
    /**
    ...
    export namespace viewModels {
         ...
         */
        namespace actions {
            var ArchActionAbortSurveyInvite: ArchActionAbortSurveyInvite;
            var ArchActionAddFlowMilestone: ArchActionAddFlowMilestone;
            var ArchActionAskForBoolean: ArchActionAskForBoolean;
            var ArchActionAskForIntent: ArchActionAskForIntent;
            var ArchActionAskForSlot: ArchActionAskForSlot;
            var ArchActionAssociateExternalContact: ArchActionAssociateExternalContact;
            var ArchActionCallBotFlow: ArchActionCallBotFlow;
            var ArchActionCallBridge: ArchActionCallBridge;
            var ArchActionCallData: ArchActionCallData;
            var ArchActionCallDataSecure: ArchActionCallDataSecure;
            var ArchActionCallDialogEngineBot: ArchActionCallDialogEngineBot;
            var ArchActionCallDialogflowBot: ArchActionCallDialogflowBot;
            var ArchActionCallLexBot: ArchActionCallLexBot;
            var ArchActionCallLexV2Bot: ArchActionCallLexV2Bot;
            var ArchActionCallBotConnector: ArchActionCallBotConnector;
            var ArchActionCallTask: ArchActionCallTask;
            var ArchActionChangeState: ArchActionChangeState;
            var ArchActionClearActiveIntent: ArchActionClearActiveIntent;
            var ArchActionClearSlot: ArchActionClearSlot;
            var ArchActionCollectInput: ArchActionCollectInput;
            var ArchActionCommunicate: ArchActionCommunicate;
            var ArchActionCompleteSurveyInvite: ArchActionCompleteSurveyInvite;
            var ArchActionCreateCallback: ArchActionCreateCallback;
            var ArchActionDataTableLookup: ArchActionDataTableLookup;
            var ArchActionDecision: ArchActionDecision;
            var ArchActionDetectSilence: ArchActionDetectSilence;
            var ArchActionDialByExtension: ArchActionDialByExtension;
            var ArchActionDisconnect: ArchActionDisconnect;
            var ArchActionEnableParticipantRecord: ArchActionEnableParticipantRecord;
            var ArchActionEndTask: ArchActionEndTask;
            var ArchActionEndWorkflow: ArchActionEndWorkflow;
            var ArchActionEvaluateSchedule: ArchActionEvaluateSchedule;
            var ArchActionEvaluateScheduleGroup: ArchActionEvaluateScheduleGroup;
            var ArchActionExitBotFlow: ArchActionExitBotFlow;
            var ArchActionExtractSecureData: ArchActionExtractSecureData;
            var ArchActionFindGroup: ArchActionFindGroup;
            var ArchActionFindLanguageSkill: ArchActionFindLanguageSkill;
            var ArchActionFindQueue: ArchActionFindQueue;
            var ArchActionFindQueueById: ArchActionFindQueueById;
            var ArchActionFindSkill: ArchActionFindSkill;
            var ArchActionFindSystemPrompt: ArchActionFindSystemPrompt;
            var ArchActionFindUser: ArchActionFindUser;
            var ArchActionFindUserById: ArchActionFindUserById;
            var ArchActionFindUserPrompt: ArchActionFindUserPrompt;
            var ArchActionFindUsersById: ArchActionFindUsersById;
            var ArchActionFlushAudio: ArchActionFlushAudio;
            var ArchActionGetConversationData: ArchActionGetConversationData;
            var ArchActionGetExternalContact: ArchActionGetExternalContact;
            var ArchActionGetExternalOrganization: ArchActionGetExternalOrganization;
            var ArchActionGetJourneyOutcome: ArchActionGetJourneyOutcome;
            var ArchActionGetJourneyOutcomeScoresBySession: ArchActionGetJourneyOutcomeScoresBySession;
            var ArchActionGetJourneySegment: ArchActionGetJourneySegment;
            var ArchActionGetJourneySession: ArchActionGetJourneySession;
            var ArchActionGetJourneySessionsByCustomer: ArchActionGetJourneySessionsByCustomer;
            var ArchActionGetJourneySessionsByExternalContact: ArchActionGetJourneySessionsByExternalContact;
            var ArchActionGetParticipantData: ArchActionGetParticipantData;
            var ArchActionGetResponse: ArchActionGetResponse;
            var ArchActionHoldMusic: ArchActionHoldMusic;
            var ArchActionInitializeFlowOutcome: ArchActionInitializeFlowOutcome;
            var ArchActionJumpToMenu: ArchActionJumpToMenu;
            var ArchActionJumpToTask: ArchActionJumpToTask;
            var ArchActionLoop: ArchActionLoop;
            var ArchActionLoopAnythingElse: ArchActionLoopAnythingElse;
            var ArchActionLoopUntil: ArchActionLoopUntil;
            var ArchActionLoopExit: ArchActionLoopExit;
            var ArchActionLoopNext: ArchActionLoopNext;
            var ArchActionMenu: ArchActionMenu;
            var ArchActionPlayAudio: ArchActionPlayAudio;
            var ArchActionPlayAudioOnSilence: ArchActionPlayAudioOnSilence;
            var ArchActionPlayEstimatedWaitTime: ArchActionPlayEstimatedWaitTime;
            var ArchActionPlayPositionInQueue: ArchActionPlayPositionInQueue;
            var ArchActionPreviousMenu: ArchActionPreviousMenu;
            var ArchActionRepeatMenu: ArchActionRepeatMenu;
            var ArchActionReturnToAgent: ArchActionReturnToAgent;
            var ArchActionSearchExternalContacts: ArchActionSearchExternalContacts;
            var ArchActionSendAutoReply: ArchActionSendAutoReply;
            var ArchActionSendResponse: ArchActionSendResponse;
            var ArchActionSetConversationData: ArchActionSetConversationData;
            var ArchActionSetIntent: ArchActionSetIntent;
            var ArchActionSetFlowOutcome: ArchActionSetFlowOutcome;
            var ArchActionSetLanguage: ArchActionSetLanguage;
            var ArchActionSetParticipantData: ArchActionSetParticipantData;
            var ArchActionSetScreenPop: ArchActionSetScreenPop;
            var ArchActionSetUUIData: ArchActionSetUUIData;
            var ArchActionSetWhisperAudio: ArchActionSetWhisperAudio;
            var ArchActionSetWrapupCode: ArchActionSetWrapupCode;
            var ArchActionSwitch: ArchActionSwitch;
            var ArchActionTask: ArchActionTask;
            var ArchActionTranscription: ArchActionTranscription;
            var ArchActionTransferToAcd: ArchActionTransferToAcd;
            var ArchActionTransferToFlow: ArchActionTransferToFlow;
            var ArchActionTransferToFlowSecure: ArchActionTransferToFlowSecure;
            var ArchActionTransferToGroup: ArchActionTransferToGroup;
            var ArchActionTransferToNumber: ArchActionTransferToNumber;
            var ArchActionTransferToUser: ArchActionTransferToUser;
            var ArchActionTransferToVoicemail: ArchActionTransferToVoicemail;
            var ArchActionUpdateData: ArchActionUpdateData;
            var ArchActionWait: ArchActionWait;
        }
        /**
         * This namespace contains Architect Scripting audio related view models.
         */
        namespace audio {
            var ArchAudio: ArchAudio;
            var ArchAudioCase: ArchAudioCase;
        }
        /**
        ...
        namespace baseClasses {
            var ArchBaseAction: ArchBaseAction;
            var ArchBaseActionAsk: ArchBaseActionAsk;
            var ArchBaseActionBot: ArchBaseActionBot;
            var ArchBaseActionDataAction: ArchBaseActionDataAction;
            var ArchBaseDefinition: ArchBaseDefinition;
            var ArchBaseActionFindSystemObject: ArchBaseActionFindSystemObject;
            var ArchBaseActionFindSystemObjects: ArchBaseActionFindSystemObject;
            var ArchBaseActionFindSystemObjectById: ArchBaseActionFindSystemObjectById;
            var ArchBaseActionFindSystemObjectByName: ArchBaseActionFindSystemObjectByName;
            var ArchBaseActionFindSystemObjectsById: ArchBaseActionFindSystemObjectsById;
            var ArchBaseActionLex: ArchBaseActionLex;
            var ArchBaseActionTransfer: ArchBaseActionTransfer;
            var ArchBaseActionTransferWithConnectTimeout: ArchBaseActionTransferWithConnectTimeout;
            var ArchBaseActionWithOutputLoop: ArchBaseActionWithOutputLoop;
            var ArchBaseActionWithOutputLoopMaxLoopsNextLoop: ArchBaseActionWithOutputLoopMaxLoopsNextLoop;
            var ArchBaseActionWithOutputs: ArchBaseActionWithOutputs;
            var ArchBaseActionWithOutputsDefaults: ArchBaseActionWithOutputsDefault;
            var ArchBaseActionWithOutputsFakeSuccessFailure: ArchBaseActionWithOutputsFakeSuccessFailure;
            var ArchBaseActionWithOutputsFakeSuccessFailureTimeout: ArchBaseActionWithOutputsFakeSuccessFailureTimeout;
            var ArchBaseActionWithOutputsFoundNotFoundFailure: ArchBaseActionWithOutputsFoundNotFoundFailure;
            var ArchBaseActionWithOutputsFoundNotFoundPartiallyFound: ArchBaseActionWithOutputsFoundNotFoundPartiallyFound;
            var ArchBaseActionWithOutputsSuccessFailure: ArchBaseActionWithOutputsSuccessFailure;
            var ArchBaseActionWithOutputsSuccessFailureTimeout: ArchBaseActionWithOutputsSuccessFailureTimeout;
            var ArchBaseActionWithOutputsYesNo: ArchBaseActionWithOutputsYesNo;
            var ArchBaseCoreObject: ArchBaseCoreObject;
            var ArchBaseCoreObjectWithId: ArchBaseCoreObjectWithId;
            var ArchBaseFilterClause: ArchBaseFilterClause;
            var ArchBaseFilterClauseProperty: ArchBaseFilterClauseProperty;
            var ArchBaseFilterClausePropertyValue: ArchBaseFilterClausePropertyValue;
            var ArchBaseFilterMatching: ArchBaseObjectFilterCommon;
            var ArchBaseFlow: ArchBaseFlow;
            var ArchBaseFlowInboundOutboundSecureCall: ArchBaseFlowInboundOutboundSecureCall;
            var ArchBaseFlowWithMenus: ArchBaseFlowWithMenus;
            var ArchBaseFlowWithTasks: ArchBaseFlowWithTasks;
            var ArchBaseFlowWorkflow: ArchBaseFlowWorkflow;
            var ArchBaseMenu: ArchBaseMenu;
            var ArchBaseMenuChoice: ArchBaseMenuChoice;
            var ArchBaseMultiActionContainer: ArchBaseMultiActionContainer;
            var ArchBaseNameValuePair: ArchBaseNameValuePair;
            var ArchBaseNameValuePairs: ArchBaseNameValuePairs;
            var ArchBaseNetworkValue: ArchBaseNetworkValue;
            var ArchBaseNetworkValueCollection: ArchBaseNetworkValueCollection;
            var ArchBaseNetworkValueContainer: ArchBaseNetworkValueContainer;
            var ArchBaseNetworkValueSingleton: ArchBaseNetworkValueSingleton;
            var ArchBaseObject: ArchBaseObject;
            var ArchBasePrompt: ArchBasePrompt;
            var ArchBaseSkillValuePair: ArchBaseSkillValuePair;
            var ArchBaseSkillValuePairs: ArchBaseSkillValuePairs;
            var ArchBaseValue: ArchBaseValue;
            var ArchBaseValueBasic: ArchBaseValueBasic;
            var ArchBaseValueCollection: ArchBaseValueCollection;
            var ArchBaseValueCollectionBasic: ArchBaseValueCollectionBasic;
            var ArchBaseValueContainer: ArchBaseValueContainer;
            var ArchBaseValueSingleton: ArchBaseValueSingleton;
            var ArchBaseVariable: ArchBaseVariable;
            var ArchBaseVariableCollection: ArchBaseVariableCollection;
            var ArchBaseVariableSingleton: ArchBaseVariableSingleton;
            var ArchBaseVariableValuePair: ArchBaseVariableValuePair;
            var ArchBaseVariableValuePairs: ArchBaseVariableValuePairs;
        }
        /**
        ...
        namespace definitions {
            var ArchDefinitionAction: ArchDefinitionAction;
            var ArchDefinitionFlow: ArchDefinitionFlow;
            var ArchDefinitionMenu: ArchDefinitionMenu;
            var ArchDefinitionValue: ArchDefinitionValue;
            var ArchDefinitionVariable: ArchDefinitionVariable;
        }
        /**
         * This namespace contains Architect Scripting filter related view models.
         */
        namespace filters {
            var ArchFilterClauseContainer: ArchFilterClauseContainer;
            var ArchFilterClausePropertyCallback: ArchFilterClausePropertyCallback;
            var ArchFilterClausePropertyValueEquals: ArchFilterClausePropertyValueEquals;
            var ArchFilterClausePropertyValueNotEquals: ArchFilterClausePropertyValueNotEquals;
            var ArchFilterObject: ArchFilterObject;
        }
        /**
         * This namespace contains Architect Scripting flow related view models.
         */
        namespace flows {
            var ArchFlowBot: ArchFlowBot;
            var ArchFlowInboundCall: ArchFlowInboundCall;
            var ArchFlowInboundChat: ArchFlowInboundChat;
            var ArchFlowInfo: ArchFlowInfo;
            var ArchFlowInfoVersion: ArchFlowInfoVersion;
            var ArchFlowInfoBasic: ArchFlowInfoBasic;
            var ArchFlowInQueueCall: ArchFlowInQueueCall;
            var ArchFlowOutboundCall: ArchFlowOutboundCall;
            var ArchFlowSecureCall: ArchFlowSecureCall;
            var ArchFlowInboundEmail: ArchFlowInboundEmail;
            var ArchFlowInboundShortMessage: ArchFlowInboundShortMessage;
            var ArchFlowSurveyInvite: ArchFlowSurveyInvite;
            var ArchFlowWorkflow: ArchFlowWorkflow;
        }
        /**
         * This namespace contains Architect Scripting menu related view models.
         */
        namespace menus {
            var ArchMenu: ArchMenu;
            var ArchMenuDialByExtension: ArchMenuDialByExtension;
            var ArchMenuDisconnect: ArchMenuDisconnect;
            var ArchMenuJumpToMenu: ArchMenuJumpToMenu;
            var ArchMenuJumpToTask: ArchMenuJumpToTask;
            var ArchMenuPreviousMenu: ArchMenuPreviousMenu;
            var ArchMenuRepeatMenu: ArchMenuRepeatMenu;
            var ArchMenuReturnToAgent: ArchMenuReturnToAgent;
            var ArchMenuSubMenu: ArchMenuSubMenu;
            var ArchMenuTask: ArchMenuTask;
            var ArchMenuTransferToAcd: ArchMenuTransferToAcd;
            var ArchMenuTransferToFlow: ArchMenuTransferToFlow;
            var ArchMenuTransferToFlowSecure: ArchMenuTransferToFlowSecure;
            var ArchMenuTransferToGroup: ArchMenuTransferToGroup;
            var ArchMenuTransferToNumber: ArchMenuTransferToNumber;
            var ArchMenuTransferToUser: ArchMenuTransferToUser;
            var ArchMenuTransferToVoicemail: ArchMenuTransferToVoicemail;
        }
        /**
         * This namespace contains Architect Scripting action output related view models.
         */
        namespace outputs {
            var ArchActionOutput: ArchActionOutput;
            var ArchBranch: ArchBranch;
        }
        /**
         * This namespace contains Architect Scripting prompt related view models.
         */
        namespace prompts {
            var ArchPromptSystem: ArchActionOutput;
            var ArchPromptUser: ArchActionOutput;
        }
        /**
         * This namespace contains Architect Scripting flow setting related view models.
         */
        namespace settings {
            var ArchSettingActionPropertyDefault: ArchSettingActionPropertyDefault;
            var ArchSettingsActionDefaults: ArchSettingsActionDefaults;
            var ArchSettingsBotFlow: ArchSettingsBotFlow;
            var ArchSettingsEventErrorFlow: ArchSettingsEventErrorFlow;
            var ArchSettingsEventErrorFlowBot: ArchSettingsEventErrorFlowBot;
            var ArchSettingsInboundEmailFlow: ArchSettingsOutboundCallFlow;
            var ArchSettingsInQueueCallFlow: ArchSettingsInQueueCallFlow;
            var ArchSettingsNluIntent: ArchSettingsNluIntent;
            var ArchSettingsMenu: ArchSettingsMenu;
            var ArchSettingsMenuFlow: ArchSettingsMenuFlow;
            var ArchSettingsOutboundCallFlow: ArchSettingsOutboundCallFlow;
            var ArchSettingsPromptsFlow: ArchSettingsPromptsFlow;
            var ArchSettingsSpeechRec: ArchSettingsSpeechRec;
            var ArchSettingsSpeechRecFlow: ArchSettingsSpeechRecFlow;
            var ArchSettingsSupportedLanguage: ArchSettingsSupportedLanguage;
            var ArchSettingsSupportedLanguagesFlow: ArchSettingsSupportedLanguagesFlow;
            var ArchSettingsUserInput: ArchSettingsUserInput;
        }
        /**
         * This namespace contains Architect Scripting flow speech recognition related view models.
         */
        namespace speechRec {
            var ArchSpeechRecTermContainer: ArchSpeechRecTermContainer;
            var ArchSpeechRecTermContainers: ArchSpeechRecTermContainers;
        }
        /**
         * This namespace contains Architect Scripting task related view models.
         */
        namespace tasks {
            var ArchTask: ArchTask;
            var ArchTaskLoop: ArchTaskLoop;
            var ArchState: ArchState;
            var ArchStateBot: ArchStateBot;
        }
        /**
         * This namespace contains Architect Scripting text to speech related view models.
         */
        namespace textToSpeech {
            var ArchTtsEngine: ArchTtsEngine;
            var archTtsEngines: ArchTtsEngines;
            var ArchTtsVoice: ArchTtsVoice;
        }
        /**
         * This namespace contains Architect Scripting traverse related view models.
         */
        namespace traverse {
            var ArchTraverseContext: ArchTraverseContext;
            var ArchTraverseHierarchyItem: ArchTraverseHierarchyItem;
            var ArchTraverseInfo: ArchTraverseInfo;
            var ArchTraverseSettings: ArchTraverseSettings;
        }
        /**
         * This namespace contains Architect Scripting flow validation related view models.
         */
        namespace validation {
            var ArchValidationIssue: ArchValidationIssue;
            var ArchValidationResults: ArchValidationResults;
        }
        /**
         ...
         */
        namespace values {
            var ArchValueAgentScorePair: ArchValueAgentScorePair;
            var ArchValueAgentScorePairCollection: ArchValueAgentScorePairCollection;
            var ArchNamedValue: ArchNamedValue;
            var ArchNamedValueList: ArchNamedValueList;
            var ArchValueAny: ArchValueAny;
            var ArchValueAnyCollection: ArchValueAnyCollection;
            var ArchValueAudio: ArchValueAudio;
            var ArchValueBoolean: ArchValueBoolean;
            var ArchValueBooleanCollection: ArchValueBooleanCollection;
            var ArchValueContactList: ArchValueContactList;
            var ArchValueCommunication: ArchValueCommunication;
            var ArchValueCurrency: ArchValueCurrency;
            var ArchValueCurrencyCollection: ArchValueCurrencyCollection;
            var ArchValueDate: ArchValueDate;
            var ArchValueDateCollection: ArchValueDateCollection;
            var ArchValueDateTime: ArchValueDateTime;
            var ArchValueDateTimeCollection: ArchValueDateTimeCollection;
            var ArchValueDecimal: ArchValueDecimal;
            var ArchValueDecimalCollection: ArchValueDecimalCollection;
            var ArchValueDuration: ArchValueDuration;
            var ArchValueDurationCollection: ArchValueDurationCollection;
            var ArchValueEmailAddress: ArchValueEmailAddress;
            var ArchValueEmailAddressCollection: ArchValueEmailAddressCollection;
            var ArchValueExternalContact: ArchValueExternalContact;
            var ArchValueExternalContactCollection: ArchValueExternalContactCollection;
            var ArchValueExternalOrganization: ArchValueExternalOrganization;
            var ArchValueExternalOrganizationCollection: ArchValueExternalOrganizationCollection;
            var ArchValueGroup: ArchValueGroup;
            var ArchValueGroupCollection: ArchValueGroupCollection;
            var ArchValueInteger: ArchValueInteger;
            var ArchValueIntegerCollection: ArchValueIntegerCollection;
            var ArchValueJourneySession: ArchValueJourneySession;
            var ArchValueJourneySessionCollection: ArchValueJourneySessionCollection;
            var ArchValueLanguageSkill: ArchValueLanguageSkill;
            var ArchValueLanguageSkillCollection: ArchValueLanguageSkillCollection;
            var ArchValuePhoneNumber: ArchValuePhoneNumber;
            var ArchValuePhoneNumberCollection: ArchValuePhoneNumberCollection;
            var ArchValuePrompt: ArchValuePrompt;
            var ArchValuePromptCollection: ArchValuePromptCollection;
            var ArchValueQueue: ArchValueQueue;
            var ArchValueQueueCollection: ArchValueQueueCollection;
            var ArchValueSettings: ArchValueSettings;
            var ArchValueSkill: ArchValueSkill;
            var ArchValueSkillCollection: ArchValueSkillCollection;
            var ArchValueString: ArchValueString;
            var ArchValueStringCollection: ArchValueStringCollection;
            var ArchValueTime: ArchValueTime;
            var ArchValueTimeCollection: ArchValueTimeCollection;
            var ArchValueUser: ArchValueUser;
            var ArchValueUserCollection: ArchValueUserCollection;
            var ArchValueWrapupCode: ArchValueWrapupCode;
            var ArchValueWrapupCodeCollection: ArchValueWrapupCodeCollection;
        }
        /**
         * This namespace contains Architect Scripting flow variable related view models.
         */
        namespace variables {
            var ArchVariableAgentScorePair: ArchVariableAgentScorePair;
            var ArchVariableAgentScorePairCollection: ArchVariableAgentScorePairCollection;
            var ArchVariableBoolean: ArchVariableBoolean;
            var ArchVariableBooleanCollection: ArchVariableBooleanCollection;
            var ArchVariableCommunication: ArchVariableCommunication;
            var ArchVariableCurrency: ArchVariableCurrency;
            var ArchVariableCurrencyCollection: ArchVariableCurrencyCollection;
            var ArchVariableDate: ArchVariableDate;
            var ArchVariableDateCollection: ArchVariableDateCollection;
            var ArchVariableDateTime: ArchVariableDateTime;
            var ArchVariableDateTimeCollection: ArchVariableDateTimeCollection;
            var ArchVariableDecimal: ArchVariableDecimal;
            var ArchVariableDecimalCollection: ArchVariableDecimalCollection;
            var ArchVariableDuration: ArchVariableDuration;
            var ArchVariableDurationCollection: ArchVariableDurationCollection;
            var ArchVariableEmailAddress: ArchVariableEmailAddress;
            var ArchVariableEmailAddressCollection: ArchVariableEmailAddressCollection;
            var ArchVariableGroup: ArchVariableGroup;
            var ArchVariableGroupCollection: ArchVariableGroupCollection;
            var ArchVariableInteger: ArchVariableInteger;
            var ArchVariableIntegerCollection: ArchVariableIntegerCollection;
            var ArchVariableJourneyOutcome: ArchVariableJourneyOutcome;
            var ArchVariableJourneyOutcomeCollection: ArchVariableJourneyOutcomeCollection;
            var ArchVariableJourneyOutcomeScore: ArchVariableJourneyOutcomeScore;
            var ArchVariableJourneyOutcomeScoreCollection: ArchVariableJourneyOutcomeScoreCollection;
            var ArchVariableJourneySegment: ArchVariableJourneySegment;
            var ArchVariableJourneySegmentCollection: ArchVariableJourneySegmentCollection;
            var ArchVariableJourneySession: ArchVariableJourneySession;
            var ArchVariableJourneySessionCollection: ArchVariableJourneySessionCollection;
            var ArchVariableLanguageSkill: ArchVariableSkill;
            var ArchVariableLanguageSkillCollection: ArchVariableSkillCollection;
            var ArchVariablePhoneNumber: ArchVariablePhoneNumber;
            var ArchVariablePhoneNumberCollection: ArchVariablePhoneNumberCollection;
            var ArchVariablePrompt: ArchVariablePrompt;
            var ArchVariablePromptCollection: ArchVariablePromptCollection;
            var ArchVariableQueue: ArchVariableQueue;
            var ArchVariableQueueCollection: ArchVariableQueueCollection;
            var ArchVariableSettings: ArchVariableSettings;
            var ArchVariableSkill: ArchVariableSkill;
            var ArchVariableSkillCollection: ArchVariableSkillCollection;
            var ArchVariableString: ArchVariableString;
            var ArchVariableStringCollection: ArchVariableStringCollection;
            var ArchVariableTime: ArchVariableTime;
            var ArchVariableTimeCollection: ArchVariableTimeCollection;
            var ArchVariableUser: ArchVariableUser;
            var ArchVariableUserCollection: ArchVariableUserCollection;
            var ArchVariableWrapupCode: ArchVariableWrapupCode;
            var ArchVariableWrapupCodeCollection: ArchVariableWrapupCodeCollection;
        }
    }
// }
